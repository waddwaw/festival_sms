...
import com.example.li.festival_sms.biz.SmsBiz;
...
public class SendMsgActivity extends AppCompatActivity {
        ...
        mFabSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(msg)) {
                    Toast.makeText(SendMsgActivity.this, "短信内容不能为空", Toast.LENGTH_LONG).show();
                    return;
                }
    ...
    private SendedMsg buildSendMsg(String msg) {
        ...
        sendedMsg.setFestivlName(mFestival.getName());
        String names ="";
